// **البينات الكاملة والموحدة**
// تم دمج ملف Question.json هنا ليعمل الكود بشكل فوري.
...
function showResults() {
    ...
    if (percentage >= 90) {
        ...
        gradeMessage.innerHTML = '✨ جيد جداً! أساس متين، لكن هناك مجال للمراجعة.';
        gradeMessage.style.color = 'var(--accent-primary)';
    } else {
        gradeMessage.innerHTML = '⚠️ تحتاج إلى مراجعة مكثفة لهذه المفاهيم.';
        gradeMessage.style.color = 'var(--incorrect-color)';
    }

    const reviewArea = document.getElementById('review-area');
    reviewArea.innerHTML = '<h3>مراجعة الأخطاء المفاهيمية:</h3>';
